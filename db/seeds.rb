...
10.times do |index|
  PreSaleCustomerPage.create!(slug: "#{index.to_s}-cosmit-customer",
                              banner: File.open(Rails.root.join("spec", "fixtures", "image.jpg")),
                              video: "https://www.youtube.com/embed/OU6K7ti2t3M",
                              observations: "just a quick observation")
end
